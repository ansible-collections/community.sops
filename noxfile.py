...
# archlinux = "quay.io/ansible-community/test-image:archlinux"  -- no longer works with ansible-core 2.19
...
for core_version in ["2.19"]:
    for docker_container in ["ubuntu2204", "ubuntu2404", "fedora41"]:
        for sops_version in ["3.5.0", "3.6.1", "3.7.3", "3.8.1", "3.9.1"]:
            add_target(core_version=core_version, docker_container=docker_container, sops_version=sops_version)
add_target(core_version="2.9", docker_container="ubuntu1604", sops_version="3.5.0")
add_target(core_version="2.9", docker_container="ubuntu1804", sops_version="3.7.1")
add_target(core_version="2.10", docker_container="ubuntu1804", sops_version="3.6.0")
add_target(core_version="2.11", docker_container="ubuntu1804", sops_version="3.7.2")
add_target(core_version="2.12", docker_container="ubuntu2004", sops_version="3.7.0")
add_target(core_version="2.13", docker_container="ubuntu2004", sops_version="3.7.3")
add_target(core_version="2.14", docker_container="ubuntu2204", sops_version="3.7.3")
add_target(core_version="2.15", docker_container="ubuntu2004", sops_version="3.7.3")
add_target(core_version="2.15", docker_container="ubuntu2204", sops_version="3.8.0")
add_target(core_version="2.15", docker_container=debian_bullseye, python_version="3.9", sops_version="latest")
add_target(core_version="2.16", docker_container="ubuntu2204", sops_version="3.8.0")
add_target(core_version="2.17", docker_container="ubuntu2204", sops_version="3.8.1")
add_target(core_version="2.17", docker_container="fedora39", sops_version="3.9.0")
add_target(core_version="2.18", docker_container="fedora40", sops_version="3.9.0")
...
add_target(core_version="2.19", docker_container="ubuntu2204", target="gha/install/3/", github_latest_detection="api")
add_target(core_version="2.19", docker_container="ubuntu2404", target="gha/install/3/", github_latest_detection="latest-release")
