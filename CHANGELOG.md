...
- <a href="#v2-3-0-b2">v2\.3\.0\-b2</a>
    - <a href="#release-summary">Release Summary</a>
    - <a href="#minor-changes">Minor Changes</a>
- <a href="#v2-3-0-b1">v2\.3\.0\-b1</a>
...
The main new features of this release are ansible\-core 2\.21 support for <code>community\.sops\.load\_vars</code>
and improved argument checking for the <code>community\.sops\.decrypt</code> filter\.
Also the handling of the <code>sops\_binary</code> option for the lookup and vars plugin have been improved\.
