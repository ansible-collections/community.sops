...
def main():
    ...
    no_comments_allowed = [
        ...
        'tests/integration/targets/filter_decrypt/files/*.sops',
        'tests/integration/targets/filter_decrypt/files/hidden-*',
        'tests/integration/targets/load_vars/vars/*.json',
        'tests/integration/targets/lookup_sops/files/*.sops',
        'tests/integration/targets/lookup_sops/files/hidden-*',
        'tests/integration/targets/sops_encrypt/files/broken-json-yaml',
        'tests/integration/targets/var_sops/test-success/host_vars/*.json',
        'LICENSES/*.txt',
        'COPYING',
    ]
